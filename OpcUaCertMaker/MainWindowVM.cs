...
namespace OpcUaCertMaker
{
    ...
    class MainWindowVM : BindableBase
    {
        ...
        private bool _caflag = true;
        public bool CAFlag
        {
            get => _caflag;
            set => SetProperty(ref _caflag, value);
        }
        ...
        private void ExecuteCreateCertificateBase(AsymmetricKeyParameter rootPrivateKey = null, Org.BouncyCastle.X509.X509Certificate rootCert = null)
        {
            ...
            {
                interKeyPath = Path.Combine(OutputFolder, BaseFileName + ".pem");
            }
            ...
            else
            {
                // KeyUsage: 0xf2
                certGen.AddExtension(X509Extensions.KeyUsage, true,
                    new KeyUsage(KeyUsage.KeyEncipherment | KeyUsage.DataEncipherment | KeyUsage.DigitalSignature | KeyUsage.NonRepudiation));
            }
            ...
            certGen.AddExtension(X509Extensions.BasicConstraints, true, new BasicConstraints(CAFlag));
